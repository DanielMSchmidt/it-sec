...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgnu --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --no-libtool --macro-prefix=gl alloca alloca-opt argp argp-version-etc autobuild dirfd dirname-lgpl error exit exitfail extensions fdl-1.3 filemode forkpty getaddrinfo getcwd getline getopt-gnu getpass gettext gettext-h getusershell glob gnupload inttostr maintainer-makefile malloc mempcpy minmax obstack poll progname readline readutmp realloc regex setenv size_max snprintf stdbool stdint strcase strchrnul strerror strndup strnlen sysexits unistd-safer unlocked-io update-copyright vasnprintf version-etc-fsf vsnprintf xalloc xalloc-die xgetcwd xgetdomainname xgethostname xsize xvasprintf
...
EXTRA_libgnu_a_SOURCES += fopen-safer.c
...
EXTRA_libgnu_a_SOURCES += forkpty.c
...
EXTRA_DIST += getdomainname.c

EXTRA_libgnu_a_SOURCES += getdomainname.c
...
EXTRA_libgnu_a_SOURCES += getusershell.c
...
EXTRA_libgnu_a_SOURCES += login_tty.c
...
EXTRA_libgnu_a_SOURCES += readline.c
...
EXTRA_libgnu_a_SOURCES += readutmp.c
...
libgnu_a_SOURCES += xgetdomainname.h xgetdomainname.c
